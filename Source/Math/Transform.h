...
//
//        /// Constructor
//        Transform(const Vector3f& position, const Matrix3x3f& orientation);
//
//        /// Constructor
//        Transform(const Vector3f& position, const QuaternionF& orientation);
//
...
//
//// Constructor
//RP3D_FORCE_INLINE Transform::Transform() : mPosition(Vector3f(0.0, 0.0, 0.0)), mOrientation(QuaternionF::identity()) {
//
//}
//
//// Constructor
//RP3D_FORCE_INLINE Transform::Transform(const Vector3f& position, const Matrix3x3f& orientation) : mPosition(position), mOrientation(QuaternionF(orientation)) {
//
//}
//
//// Constructor
//RP3D_FORCE_INLINE Transform::Transform(const Vector3f& position, const QuaternionF& orientation)
//          : mPosition(position), mOrientation(orientation) {
//
//}
//
//// Return the position of the transform
//RP3D_FORCE_INLINE const Vector3f& Transform::getPosition() const {
//    return mPosition;
//}
//
//// Set the origin of the transform
//RP3D_FORCE_INLINE void Transform::setPosition(const Vector3f& position) {
//    mPosition = position;
//}
//
//// Return the rotation matrix
//RP3D_FORCE_INLINE const QuaternionF& Transform::getOrientation() const {
//    return mOrientation;
//}
//
//// Set the rotation matrix of the transform
//RP3D_FORCE_INLINE void Transform::setOrientation(const QuaternionF& orientation) {
//    mOrientation = orientation;
//}
//
//// Set the transform to the identity transform
//RP3D_FORCE_INLINE void Transform::setToIdentity() {
//    mPosition = Vector3f(0.0, 0.0, 0.0);
//    mOrientation = QuaternionF::identity();
//}                                           
//
//// Return the inverse of the transform
//RP3D_FORCE_INLINE Transform Transform::getInverse() const {
//    const QuaternionF& invQuaternion = mOrientation.getInverse();
...
//                                                  float interpolationFactor) {
//
//    Vector3f interPosition = oldTransform.mPosition * (float(1.0) - interpolationFactor) +
//                            newTransform.mPosition * interpolationFactor;
//
//    QuaternionF interOrientation = QuaternionF::slerp(oldTransform.mOrientation,
...
//    return Transform(Vector3f(0, 0, 0), QuaternionF::identity());
//}
//
//// Return true if it is a valid transform
...
//
//// Return the transformed vector
//RP3D_FORCE_INLINE Vector3f Transform::operator*(const Vector3f& vector) const {
...
//
//    return Transform(Vector3f(mPosition.x + mOrientation.w * prodX - prodY * mOrientation.z + prodZ * mOrientation.y - prodW * mOrientation.x,

...
CollisionComponent::CollisionComponent(Actor* _owner, const string& _channelName, const int _status, const CollisionType& _type) : CComponent(_owner)
{
...
CollisionComponent::CollisionComponent(Actor* _owner, const CollisionComponent& _other) : CComponent(_owner)
{
...
void CollisionComponent::Construct()
{
	...
	if (channelName != "NONE")
	{
		...
		GetOwner()->GetWorld()->GetCollisionManager().AddCollision(this);
	}
}
...
void CollisionComponent::Deconstruct()
{
	...
	GetOwner()->GetWorld()->GetCollisionManager().RemoveCollision(this);
}
...
void CollisionComponent::ComputeCollisions()
{
	...
	CollisionManager* _collisionManager = &owner->GetWorld()->GetCollisionManager();
